package com.chattthedev.foodscentral.Services;
...
import com.chattthedev.foodscentral.Activities.ReceiveNotificationActivity;
    ...
    public void onMessageReceived(@NonNull RemoteMessage remoteMessage) {
        ...
        NotificationCompat.Builder notificationBuilder =
                new NotificationCompat.Builder(this, "TAC")
                        ...
                        .setContentText(body)
                        .setSmallIcon(R.drawable.restaurants).setSound(defaultSound);
